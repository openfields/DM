# From Appendix A, Zipkin et al. 2014, Ecology
# Code for simulation study

######################################################################
######################################################################
# N(i,j,t) – Estimated abundance in stage i, site j, year t 
# The components that make up the annual estimates of N: G 
# (recruited/immigrated), S (survived) and T (transitioned) are 
# as described in the main text 

# The data 
# n(i,j,k,t)- Observed number of individuals in stage i at 
# location j, repeated measure k in year t 

# To be passed as data: n, nStages, nSites, nReps, nYears 
